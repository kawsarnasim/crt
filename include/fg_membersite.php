...
class FGMembersite {
    ...
    function CheckLoginInDB($username, $password) {
        ...
        $pwdmd5 = md5($password);
        $qry = "Select name, userTypeId, email from $this->tablename where username='$username' and password='$pwdmd5' and confirmcode='y'";

        $result = mysql_query($qry, $this->connection);
        $num_of_r = mysql_num_rows($result);
        echo "<script type=\"text/javascript\">window.alert(\"username = $username, pass = $pwdmd5, query=$qry, result=$num_of_r\")</script>";
        ...
        $_SESSION['type_of_user'] = $row['userTypeId'];
    ...
    function UpdateDBRecForConfirmation(&$user_rec) {
        ...
        $result = mysql_query("Select name, userTypeId, email from $this->tablename where confirmcode='$confirmcode'", $this->connection);
        if (!$result || mysql_num_rows($result) <= 0) {
